...
function M.load(colors, opts)
  ...
  local highlights = {
    ...
    { "Conditional", { fg = colors.keyword, italic = italic } },
    ...
    { "Keyword", { fg = colors.keyword, italic = italic } },
    { "Label", { fg = colors.fg3 } },
    ...
    { "Statement", { fg = colors.keyword, italic = italic } },
    ...
    { "semshiUnresolved", { fg = colors.fg3 } },
