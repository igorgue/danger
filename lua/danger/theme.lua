...
M.load = function(opts, colors)
	...
	-- Todo
	hi("TodoBgTODO", { fg = is_dark and colors.bg or colors.fg, bg = colors.str, bold = true })
	hi("TodoFgTODO", { fg = colors.str })
	hi("TodoSignTODO", { fg = colors.str })
	hi("TodoBgFIX", { fg = is_dark and colors.bg or colors.fg, bg = colors.error, bold = true })
	hi("TodoFgFIX", { fg = colors.error })
	hi("TodoSignFIX", { fg = colors.error })
	hi("TodoBgPERF", { fg = is_dark and colors.bg or colors.fg, bg = colors.success, bold = true })
	hi("TodoFgPERF", { fg = colors.success })
	hi("TodoSignPERF", { fg = colors.success })
	hi("TodoBgWARN", { fg = is_dark and colors.bg or colors.fg, bg = colors.warning, bold = true })
	hi("TodoFgWARN", { fg = colors.warning })
	hi("TodoSignWARN", { fg = colors.warning })
	hi("TodoBgTEST", { fg = is_dark and colors.bg or colors.fg, bg = colors.builtin, bold = true })
	hi("TodoFgTEST", { fg = colors.builtin })
	hi("TodoSignTEST", { fg = colors.builtin })
	hi("TodoBgNOTE", { fg = is_dark and colors.bg or colors.fg, bg = colors.comment, bold = true })
	hi("TodoFgNOTE", { fg = colors.comment })
	hi("TodoSignNOTE", { fg = colors.comment })
	hi("TodoBgHACK", { fg = is_dark and colors.bg or colors.fg, bg = colors.warning2, bold = true })
