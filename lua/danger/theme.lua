...
function M.load(colors, opts)
  ...
  local highlights = {
    ...
    { "DiagnosticUnderlineError", { fg = colors.error, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineWarning", { fg = colors.warning, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineWarn", { fg = colors.warning, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineInformation", { fg = colors.comment, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineInfo", { fg = colors.comment, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineHint", { fg = colors.fg5, bg = colors.none, undercurl = true } },
    { "DiagnosticUnderlineOk", { fg = colors.success, bg = colors.none, undercurl = true } },
    ...
    { "DiagnosticFloatingHint", { fg = colors.fg5, bg = colors.none } },
