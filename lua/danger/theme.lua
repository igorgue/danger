...
function M.load(colors, opts)
  ...
  local is_dark = opts.style == "dark" or opts.style == "red_and_black" or opts.style == "mnml" or opts.style == "black" or opts.style == "white_on_black"
  ...
  local highlights = {
    ...
    { "OkMsg", { fg = colors.success, bold = bold } },
    { "WarningMsg", { fg = colors.paren, bold = bold } },
    { "ErrorMsg", { fg = colors.warning, bold = bold } },
    ...
    { "SidekickDiffContext", { bg = colors.bg6 } },
